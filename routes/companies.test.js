...
describe("GET /companies", function () {
  ...
  test("works with min/max filtering", async function () {
  ...
  test("400 Error if min > max", async function () {
    const resp = await request(app).get("/companies?minEmployees=3&maxEmployees=2");
    expect(resp.statusCode).toEqual(400)
  });

  test("works with min/max/name filtering", async function () {
  ...
  test("Can filter down to nothing", async function () {
    const resp = await request(app).get("/companies?name=e");
    expect(resp.statusCode).toEqual(200)
